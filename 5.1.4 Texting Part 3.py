...
def drawMessage(message, isFromMyself):
    ...
    if (isFromMyself==True):
        ...
        tail=Polygon(335,textBubble.centerY,360,textBubble.bottom,335,textBubble.bottom,fill="dodgerBlue")
        ...
        tail=Polygon(65,textBubble.centerY,40,textBubble.bottom,65,textBubble.bottom,fill="gainsboro")
