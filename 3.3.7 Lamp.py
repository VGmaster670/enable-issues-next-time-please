...
# picture frame
Polygon(40, 50, 90, 50, 90, 100, 40, 100, fill=None, border="seaGreen", borderWidth=5)
Polygon(50, 60, 80, 60, 80, 90, 50, 90, fill=gradient("tan", "seaGreen", start="left"))
...
Polygon(190, 305, 190, 320, 220, 320, 220, 247, 200, 250, 200, 305, fill="tan")
...
Polygon(220, 340, 250, 340, 250, 270, 230, 275, 230, 325, 220, 325, fill="tan")
