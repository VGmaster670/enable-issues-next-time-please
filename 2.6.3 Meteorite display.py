...
meteorite = Polygon(
    ...
    240,
    300,
    fill=gradient(rgb(110, 185, 160), rgb(10, 50, 45), start="left-top"),
)
cover = Rect(
    50, 75, 300, 225, fill=gradient("white", "azure", start="left-top"), opacity=20
)

Rect(50, 75, 300, 275, fill=None, border=rgb(90, 80, 80))

alarm = Polygon(
    150, 0, 250, 0, 230, 40, 170, 40, fill=gradient("lightGrey", "darkGrey")
)
light = Polygon(170, 40, 230, 40, 320, 300, 80, 300, fill="lightYellow", opacity=20)
alarmCover = Rect(0, 0, 400, 400, fill="red", opacity=50, visible=False)
alarmLights = Star(
    200, 0, 500, 10, fill="white", opacity=50, visible=False, roundness=20
)
