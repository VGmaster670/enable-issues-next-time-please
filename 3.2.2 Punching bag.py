...
glove = Group(
    Oval(
        ...
        42,
        32,
        fill=gradient("red", "crimson", start="right-top"),
        border="darkRed",
        rotateAngle=-30,
    ),
    Oval(
        ...
        85,
        75,
        fill=gradient("red", "crimson", start="right-bottom"),
        border="darkRed",
    ),
    Oval(
        80,
    ...
    Rect(
        ...
        30,
        75,
        fill=gradient("red", "crimson", start="right"),
        border="darkRed",
        align="center",
    ),
...
punchingBag = Group(
    Oval(
        ...
        100,
        50,
        fill=gradient("red", "crimson", start="left"),
        border="darkRed",
    ),
...
hit = Star(
    275, 200, 40, 11, fill=gradient("yellow", "orange"), border="darkRed", visible=False
)
