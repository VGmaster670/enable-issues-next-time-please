...
def drawBug(x, y):
    Oval(x, y, 100, 40, fill=gradient("saddleBrown", rgb(120, 15, 10), start="top"))
...
def checkGameOver():
    ...
    if upCount == len(app.bugs):
        Rect(50, 185, 300, 100, fill=gradient("maroon", "crimson"), border="white")
        Label("Game Over", 200, 235, fill="white", size=50, font="monospace", bold=True)
        app.stop()
