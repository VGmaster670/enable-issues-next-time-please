...
# box
Polygon(
    155, 230, 105, 180, 235, 180, 285, 230, fill="mediumSpringGreen", border="black"
)
Line(235, 180, 235, 230)
Polygon(
    155, 230, 155, 360, 105, 310, 105, 180, fill="mediumSpringGreen", border="black"
)
...
lid = Polygon(
    155, 230, 105, 180, 235, 180, 285, 230, fill="springGreen", border="black"
)
