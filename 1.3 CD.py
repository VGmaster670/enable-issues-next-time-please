...
Circle(
    ...
    200,
    150,
    fill=gradient("fuchsia", "darkTurquoise", "blueViolet", start="top-left"),
)
...
### Place Your Code Here ###
Label(
    "CS Academy", 220, 130, fill="white", font="arial", size=20, bold=True, italic=True
)
Label(
    "Coding Bops", 220, 270, fill="white", font="arial", size=20, bold=True, italic=True
)
